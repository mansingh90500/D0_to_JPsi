...
for i in range(20, 25):
    ...
    #config.General.workArea = '/afs/cern.ch/user/s/sayan/crab_submissions/OO_Data_MINIAOD'
    config.General.workArea = '/eos/cms/store/group/phys_heavyions/singhm/Pranjal_OO_Data_MINIAOD'
    #config.General.requestName = f'2pc_corr_jpsi_vs_ch_20260428_v96_LM_Nassoc_flow{i}'
    config.General.requestName = f'2pc_corr_jpsi_vs_ch_20260511_v96_Cent_flow{i}'
